  ...
  <section class="pt-8 pt-xl-9">
    <b-container>
      <b-row class="align-items-center">
        <b-col md="9" lg="6" class="text-center mx-auto">
          <figure>
            <svg
              version="1.1"
              ...
              x="0px"
              y="0px"
              viewBox="0 0 821.3 367.2"
              style="enable-background: new 0 0 821.3 367.2"
              xml:space="preserve"
            >
              <polygon
                class="fill-body"
                points="332.2,56.2 335.4,56.7 332.5,56"
              />
              <path
                class="fill-body"
              ...
              <polygon
                class="fill-white"
                points="552,367 301,340.8 315.6,220.8 566.5,246.9"
              />
              <polygon
                class="fill-primary opacity-4"
                points="552,367 301,340.8 315.6,220.8 566.5,246.9"
          ...
          <h4>Something gone wrong!</h4>
          <p class="mb-4">The page you were looking for doesn't exist</p>
          <router-link
