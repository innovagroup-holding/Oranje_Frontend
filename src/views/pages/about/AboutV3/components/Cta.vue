      ...
      <div class="inner-container-small text-center">
        <figure class="mb-4">
          <svg
            ...
            style="enable-background: new 0 0 223.6 87.2"
            xml:space="preserve"
          >
            <path
              class="fill-mode"
        ...
        <div class="d-grid d-sm-flex justify-content-center gap-2 gap-sm-4">
          <a href="#" class="btn btn-lg btn-light border mb-0">learn more</a>
          <router-link
            :to="{ name: 'about-us' }"
            class="btn btn-lg btn-dark border mb-0"
            >View open role</router-link
          >
        </div>
      </div>
    </b-container>
