      ...
      <b-row class="align-items-center">
        <b-col md="7" xl="6">
          ...
          <p class="mb-4">
            ...
            technologies to promote products, services, or brands to a target
            audience.
          </p>
        </b-col>
        ...
        <b-col md="4" class="ms-auto text-md-end">
          <router-link
            :to="{ name: 'contact' }"
            class="btn btn-lg btn-primary mb-6 mb-md-0"
            >Start your project</router-link
          >
        </b-col>
      </b-row>
    </b-container>
  ...
  <section class="pt-0 mt-n7">
    <b-container>
      ...
      >
        ...
        <div
          class="position-absolute top-50 start-50 translate-middle z-index-2"
        >
          <CustomGLightbox
